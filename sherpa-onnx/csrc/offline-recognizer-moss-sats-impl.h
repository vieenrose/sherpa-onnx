// sherpa-onnx/csrc/offline-recognizer-moss-sats-impl.h
//
// Copyright (c)  2026   zengyw

#ifndef SHERPA_ONNX_CSRC_OFFLINE_RECOGNIZER_MOSS_SATS_IMPL_H_
#define SHERPA_ONNX_CSRC_OFFLINE_RECOGNIZER_MOSS_SATS_IMPL_H_
...
class OfflineRecognizerMossSatsImpl : public OfflineRecognizerImpl {
 public:
  explicit OfflineRecognizerMossSatsImpl(const OfflineRecognizerConfig &config);

  template <typename Manager>
  OfflineRecognizerMossSatsImpl(Manager *mgr,
...
#endif  // SHERPA_ONNX_CSRC_OFFLINE_RECOGNIZER_MOSS_SATS_IMPL_H_
